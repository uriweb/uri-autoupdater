<?php
/*
Plugin Name: URI AutoUpdater
Plugin URI: http://www.uri.edu
Description: Automatic updates for URI plugins and themes
Version: 0.1.0
...
// @todo: test for the presence of Parsedown.php to alert admins
/**
 * Checks if the Parsedown.php file is present
 *
...
function uri_autoupdater_activate() {
  ...
  if ( current_user_can( 'activate_plugins' ) && ! file_exists( dirname(__FILE__) . '/Parsedown.php' ) ) {
    ...
    esc_html__( 'URI Autoupdater plugin requires that the ', 'uri' ) . 
    '<a href="' . esc_url( 'https://github.com/erusev/parsedown' ) . '">Parsedown.php</a>' . 
    esc_html__( ' file to be present in the uri_autoupdater plugin directory.', 'uri' ) . '</p>';
...
/**
 * Add this to each plugin/theme to add autoupdate support
 *
 * There's probably a better way to do it, but this should work.
 * It'll run after all plugins have been loaded.
 *
